  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      templateContent = '<table>'+
         '<tr>'+
           '<td><a href="#" data-action="incrementHour"><span class="' + this.upArrowStyle + '"></span></a></td>'+
           '<td class="separator">&nbsp;</td>'+
           '<td><a href="#" data-action="incrementMinute"><span class="' + this.upArrowStyle + '"></span></a></td>'+
           (this.showSeconds ?
             '<td class="separator">&nbsp;</td>'+
             '<td><a href="#" data-action="incrementSecond"><span class="' + this.upArrowStyle + '"></span></a></td>'
           : '') +
           (this.showMeridian ?
             '<td class="separator">&nbsp;</td>'+
             '<td class="meridian-column"><a href="#" data-action="toggleMeridian"><span class="' + this.upArrowStyle + '"></span></a></td>'
           : '') +
         '</tr>'+
         '<tr>'+
           '<td>'+ hourTemplate +'</td> '+
         ...
         '</tr>'+
         '<tr>'+
           '<td><a href="#" data-action="decrementHour"><span class="' + this.downArrowStyle + '"></span></a></td>'+
           '<td class="separator"></td>'+
           '<td><a href="#" data-action="decrementMinute"><span class="' + this.downArrowStyle + '"></span></a></td>'+
           (this.showSeconds ?
            '<td class="separator">&nbsp;</td>'+
            '<td><a href="#" data-action="decrementSecond"><span class="' + this.downArrowStyle + '"></span></a></td>'
           : '') +
           (this.showMeridian ?
            '<td class="separator">&nbsp;</td>'+
            '<td><a href="#" data-action="toggleMeridian"><span class="' + this.downArrowStyle + '"></span></a></td>'
           : '') +
         '</tr>'+
       '</table>';
